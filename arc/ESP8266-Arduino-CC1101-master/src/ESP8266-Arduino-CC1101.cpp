...
void cc1101signalsInterrupt(void) {
  Serial.println("cc1101signalsInterrupt");
...
void setup() {
  ...
  cc1101.disableAddressCheck(); // if not specified, will only display "packet
                                // received"
  ...
  attachInterrupt(PORT_GDO0, cc1101signalsInterrupt, FALLING);
