...
#define CC1101_RCCTRL1_STATUS                                                  \
  0x3C /*  RCCTRL1    - Last RC Oscillator Calibration Result */
#define CC1101_RCCTRL0_STATUS                                                  \
  0x3D /*  RCCTRL0    - Last RC Oscillator Calibration Result */
...
typedef uint8_t CC1101_BURST_REGISTERS[47];
